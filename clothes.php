...
// Query children needing clothes assistance
$sql = "SELECT ChildID, Name, Amount FROM children WHERE Category = 'Clothes'";
...
<head>
    ...
    <title>Children Needing Clothes Assistance</title>
...
<body>
    <div class="container">
        <h2>Children Needing Clothes </h2>
        ...
        <?php else : ?>
            <p>No children need clothes at the moment.</p>
        <?php endif; ?>
    </div>
</body>
<body>
