...
$sql = "SELECT * FROM children WHERE Age >= 0 AND Age <= 5 AND status = 'Available for Foster Care'";
...
<head>
    ...
    <title>Children Available for Foster Care (0-5)</title>
</head>
<body>
    <div class="container">
        <h2>Children Available for Foster Care (0-5)</h2>
        <table class="table">
            <thead>
                <tr>
                    <th>Child ID</th>
