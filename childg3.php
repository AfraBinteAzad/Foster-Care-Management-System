...
$sql = "SELECT * FROM children WHERE Age >= 13 AND Age <= 18 AND status = 'Available for Foster Care'";
...
<head>
    ...
    <title>Children Available for Foster Care (13-18)</title>
</head>
<body>
    <div class="container">
        <h2>Children Available for Foster Care (13-18)</h2>
        <table class="table">
            <thead>
                <tr>
                    <th>Child ID</th>
