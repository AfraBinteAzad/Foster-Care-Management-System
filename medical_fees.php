...
$sql = "SELECT ChildID, Name, Amount FROM children WHERE Category = 'Medical'";
...
<head>
    ...
    <title>Children Needing Assistance with Medical Bills</title>
...
<body>
    <div class="container">
        <h2>Children Needing Assistance with Medical Bills</h2>
        ...
        <?php else : ?>
            <p>No children need assitance with medical bills at the moment.</p>
        <?php endif; ?>
    </div>
</body>
<body>
